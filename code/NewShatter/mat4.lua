...
require ('script/newShatter/vec4')
require ('script/newShatter/vec3')

local mt = {
    __mul = function(a, b)
        if type(b) == "number" then
            return shatter_mat4(a.m00 * b, a.m01 * b, a.m02 * b, a.m03 * b,
...
function shatter_mat4(v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15,v16)
...
function makePerspective(fovY, aspect, nearZ, farZ)
    ...
    return shatter_mat4(cot/aspect, 0,0,0,
            0, cot,0,0,
...
function makeLookAt(eye, center, up)
    ...
    return shatter_mat4(side.x, up.x,forward.x,0,
