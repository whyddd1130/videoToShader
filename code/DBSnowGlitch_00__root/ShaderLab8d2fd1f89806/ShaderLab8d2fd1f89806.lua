...
ShaderLab8d2fd1f89806 = {}

function ShaderLab8d2fd1f89806:matchWithId(effectId)
    return 'KFM ShaderLab ShaderLab8d2fd1f89806' == effectId
end

function ShaderLab8d2fd1f89806.createWithId(effectId)
    if not ShaderLab8d2fd1f89806:matchWithId(effectId) then
        return nil
    end
    local o = { drawer = {}, _frame = 0, _progress = 0.0 }
    o = newObject(o, ShaderLab8d2fd1f89806)
    o:init()
    return o
end

function ShaderLab8d2fd1f89806:init()
    self.drawer = CGE.TextureDrawer:createWithShader(vs, fs)
end

function ShaderLab8d2fd1f89806:valueType(index)
    if index == 1 then
...
function ShaderLab8d2fd1f89806:updateValue(index, val1, val2, val3)
    if index == 1 then
        self._progress = val1
    end
end

function ShaderLab8d2fd1f89806:resize(width, height)
end

function ShaderLab8d2fd1f89806:updateTimeAndFrame(time, frame)
    local f = frame or self._frame or 0
    self._frame = f
    self._progress = math.max(0.0, math.min(1.0, f / 124.0))
end

function ShaderLab8d2fd1f89806:_sendTimeUniforms()
...
function ShaderLab8d2fd1f89806:render(outFBO, inputTex)
...
function ShaderLab8d2fd1f89806:onDestroy()
end
